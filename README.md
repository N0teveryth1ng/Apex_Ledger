...
|-------|--------|-------------|
| ![Login](https://i.imgur.com/placeholder1.png) | ![Wallet](https://i.imgur.com/placeholder2.png) | ![Rank](https://i.imgur.com/placeholder3.png) |

> Replace placeholder links with actual screenshots from your app.
